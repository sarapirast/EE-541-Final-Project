...
# 2. Convert Rasa examples → pandas DataFrame
...
train_sub, val_sub = train_test_split(train_df, test_size=0.2, shuffle=True, random_state=42)
...
for intent, idx in list(intent2idx.items())[:10]:
